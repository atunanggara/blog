---
aliases:
- /fastpages/2020/03/25/First-Post
categories:
- fastpages
date: '2020-03-25'
...
![covid-19](images/markdown_posts/first_post/covid-19wordcloud.jpg "https://flic.kr/p/2iDBF1E")
...
![covid-19](images/markdown_posts/first_post/index-html.png)
...
![edit pages](images/markdown_posts/first_post/Index-playaround.png)
...
- The welcome image is taken from [flickr](https://flic.kr/p/7BWCTs). I embedded the image by uploading it into github repository `images` folder and coding it into the page (`![edit pages](images/markdown_posts/first_post/Index-playaround.png)`).

### About Me

The `About Me` page can be accessed under `_pages/about.md` on the main repository:
![about me](images/markdown_posts/first_post/blog_about.png)
